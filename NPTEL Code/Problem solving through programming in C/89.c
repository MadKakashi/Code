...
int main() 
{
    ...
    /*n1 size of first array (i.e. arr1[]), n2 size of second array(i.e. arr2[]), size is the total size of the new array (array_new[]) */
   ...
   for (i = 0; i< n2; i++)
    scanf("%d", &arr2[i]); //Accepts the values for second array//Printing after merging
